...
- A request flow looks like: controller receives the HTTP call, delegates to a service, the service calls Prisma, Prisma returns typed data, the service returns a DTO, and the controller sends the response.
